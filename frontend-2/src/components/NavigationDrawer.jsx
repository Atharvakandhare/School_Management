            ...
            SCHOOL_ADMIN: [
                ...
                },
                {
                    ...
                    items: [
                        ...
                        { name: 'Reports', path: '/attendance/report', icon: 'mdi:file-chart' },
                    ],
                },
                {
                    title: 'Exams',
                    items: [
                        ...
                        { name: 'Results', path: '/exams/results', icon: 'mdi:chart-bar' },
                        { name: 'Report Cards', path: '/exams/reports', icon: 'mdi:card-account-details' },
                    ],
                },
                {
                    title: 'Finance',
                    items: [
                        ...
                        { name: 'Collect Fees', path: '/finance/collection', icon: 'mdi:cash-register' },
                        { name: 'Payroll', path: '/finance/payroll', icon: 'mdi:cash-multiple' },
                    ],
                },
            ],
        };
